...
class CourseController extends Controller
{
    ...
    public function StoreCourse(Request $request){
        ...
        $image->move(public_path('upload/course/thambnail/'), $name_gen);
    ...
    public function UpdateCourse(Request $request){
        ...
        public function SaveLecture(Request $request){
            ...
            return response()->json(['success' => 'Lecture Saved Sussfully']);
    ...
    public function UpdateCourseLecture(Request $request){
        ...
        $notification = array(
            'message' => 'Course Lecture Updated Sussfully ',
            'alert-type' => 'success'
        );
        return redirect()->back()->with($notification);
    ...
    public function DeleteLecture($id){
        ...
        $notification = array(
            'message' => 'Course Lecture Deleted Sussfully ',
            'alert-type' => 'success'
        );
        return redirect()->back()->with($notification);
    ...
    public function DeleteSection($id){
        ...
        $notification = array(
            'message' => 'Course Section Deleted Sussfully ',
            'alert-type' => 'success'
        );
        return redirect()->back()->with($notification);
