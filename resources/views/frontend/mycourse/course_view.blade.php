            ...
            <div class="question-overview-result-wrap">
                <div class="lecture-overview-item">
                    <div
                        ...
                        <h3 class="fs-17 font-weight-semi-bold">{{ count($allqueston) }} questions in this course
                        </h3>
                        <button
...
@endphp
                        ...
                        <div class="media media-card border-bottom border-bottom-gray py-4 px-3">
                            <div class="media-img rounded-full flex-shrink-0 avatar-sm">
                                <img class="rounded-full" src="{{ (!empty($que->user->photo)) ? url('upload/user_images/'.$que->user->photo) : url('upload/no_image.jpg') }}"
                                    alt="User image">
                            </div>
            ...
            @endphp
                        ...
                        @foreach ($replay  as $repl)
                  
                        <div class="media media-card border-bottom border-bottom-gray py-4 px-3" style="background: #e6e6e6">
                            <div class="media-img rounded-full flex-shrink-0 avatar-sm">
                                <img class="rounded-full" src="{{ (!empty($repl->instructor->photo)) ? url('upload/instructor_images/'.$repl->instructor->photo) : url('upload/no_image.jpg') }}"
                                    alt="User image">
                            </div>
                            <div class="media-body">
                                <div
                                    ...
                                    <div class="question-meta-content">
                                        <a href="javascript:void(0)" class="d-block">
                                            <h5 class="fs-16 pb-1">{{ $repl->instructor->name }}</h5>
                                            <p class="text-truncate fs-15 text-gray">{{ $repl->question }}</p>
                                        </a>
                                    </div><!-- end question-meta-content -->
                                ...
                                <p class="meta-tags pt-1 fs-13">
                                    ...
                                    <span>{{ Carbon\Carbon::parse($repl->created_at)->diffForHumans() }}</span>
                                </p>
                            </div><!-- end media-body -->
                        </div><!-- end media -->
                        ...
                        <div class="course-dashboard-side-content">
                            <div class="accordion generic-accordion generic--accordion" id="accordionCourseExample">
                                ...
                                @foreach ($section as $sect)
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="headingOne{{ $sect->id }}">
                                            <button class="btn btn-link" type="button" data-toggle="collapse"
                                                data-target="#collapseOne{{ $sect->id }}" aria-expanded="true"
                                                aria-controls="collapseOne">
                                                <i class="la la-angle-down"></i>
                                                <i class="la la-angle-up"></i>
                                                <span class="fs-15">{{ $sect->section_title }}</span>
                                                <span class="course-duration">
                                        ...
                                        <div id="collapseOne{{ $sect->id }}" class="collapse"
                                            aria-labelledby="headingOne{{ $sect->id }}"
