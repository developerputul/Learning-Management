        ...
        $.ajax({
            ...
            success:function(response){
                ...
                $('#wishQty').text(response.wishQty);
                 ...
                 $.each(response.Wishlist, function(key, value){
                    rows += ` <div class="col-lg-4 responsive-column-half">
            <div class="card card-item">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title"><a href="/course/details/${value.course.id}/${value.course.course_name_slug}">
                        ${value.course.course_name}</a></h5>
    ...
    function cart(){
        $.ajax({
            ...
            success:function(response){
                ...
                $('span[id="cartSubTial"]').text(response.cartTotal);
            ...
            if (data.total) {
                ...
                <ul class="generic-list-item pb-4">
                    ...
                    <li class="d-flex align-items-center justify-content-between font-weight-semi-bold">
                        ...
                        <span>${data.coupon_name} <button type="button" class="icon-element icon-element-xs 
                            shadow-sm border-0" data-toggle="tooltip" data-placement="top" onclick="couponRemove()">
                            <i class="la la-times"></i>
                        </button></span>
