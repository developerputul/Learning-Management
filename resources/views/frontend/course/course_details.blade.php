                ...
                @endphp
                               ...
                               <div class="card">
                                   <div class="card-header" id="heading{{ $sect->id }}">
                                       <button class="btn btn-link d-flex align-items-center justify-content-between" data-toggle="collapse" data-target="#collapse{{ $sect->id }}" aria-expanded="true" aria-controls="collapse{{ $sect->id }}">
            ...
            @endphp
                ...
                <div class="input-group mb-2" id="couponField">
                    ...
                    <div class="input-group-append">
                        ...
                        <a type="submit" onclick="applyInstCoupon()" class="btn theme-btn">Apply Code</a>
                    </div>
                </div>
