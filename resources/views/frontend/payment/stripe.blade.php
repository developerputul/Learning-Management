...
<head>
    ...
    <!-- inject:css -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">    <link rel="stylesheet" href="{{ asset('frontend/css/line-awesome.css')}}">
    ...
    <div class="row">
        <div class="col-lg-7">
            ...
            <div class="input-box col-lg-12">
                ...
                <div class="form-group">
                    <input id="phone" class="form-control form--control" type="phone" name="phone" value="{{ Auth::user()->phone }}">
                </div>
            </div><!-- end input-box -->
                    ...
                    <div class="divider-2 mb-30">
                        <div class="table-responsive order_table checkout">
                            ...
                            <form action="{{ route('stripe_order') }}" method="post" id="payment-form">
                                ...
                                <div class="form-row">
                                   <label for="card-element">Cradit or Debit Cart</label>
