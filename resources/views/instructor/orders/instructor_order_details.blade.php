                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                   ...
                                   @if ($payment->status == 'pending')
                                    <a href="{{ route('pending-confirm',$payment->id) }}" class="btn btn-block btn btn-success" id="confirm">Confirm Order</a>
                                    @elseif ($payment->status == 'confirm')
                                    <a href="" class="btn btn-block btn btn-success">Confirm Order</a>
                                   @endif
